...
export declare type APITweetExpansionsParameterType = 'attachments.poll_ids' | 'attachments.media_keys' | 'author_id' | 'entities.mentions.username' | 'geo.place_id' | 'in_reply_to_user_id' | 'referenced_tweets.id' | 'referenced_tweets.id.author_id';
export declare const APITweetExpansionsParameters: Array<APITweetExpansionsParameterType>;
export declare type APITweetFieldsParameterType = keyof APITweet;
export declare const APITweetFieldsParameters: Array<APITweetFieldsParameterType>;
...
export declare type MultipleTweetsLookupQuery = SingleTweetLookupQuery;
